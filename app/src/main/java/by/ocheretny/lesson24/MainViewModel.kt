...
class MainViewModel : ViewModel() {
    ...
    val characters = ArrayList<Character>().apply {
        ...
        this.add(Character("Crypto","https://i.pinimg.com/originals/74/fc/4d/74fc4dac174d89ba087d8ab4579a6b06.png",2544,2375,88))
    }
